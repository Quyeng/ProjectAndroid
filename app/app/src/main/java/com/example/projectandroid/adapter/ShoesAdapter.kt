...
import com.example.projectandroid.activity.ShoesActivity
import com.example.projectandroid.model.Product
import com.squareup.picasso.Picasso
import java.text.DecimalFormat

class ShoesAdapter(context: ShoesActivity, layout: Int, subjectsList: List<Product>) :
    BaseAdapter() {
    var x = 0
    private val context: ShoesActivity
