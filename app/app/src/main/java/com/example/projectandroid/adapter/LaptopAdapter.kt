...
import com.example.projectandroid.activity.LaptopActivity
...
class LaptopAdapter(context: LaptopActivity, layout: Int, subjectsList: List<Product>) :
    BaseAdapter() {
    var x = 0
    private val context: LaptopActivity
