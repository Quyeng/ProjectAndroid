...
import com.example.projectandroid.activity.SmartPhoneActivity
import com.example.projectandroid.model.Product
import com.squareup.picasso.Picasso
import java.text.DecimalFormat

class PhoneAdapter(context: SmartPhoneActivity, layout: Int, subjectsList: List<Product>) :
    BaseAdapter() {
    var x = 0
    private val context: SmartPhoneActivity
