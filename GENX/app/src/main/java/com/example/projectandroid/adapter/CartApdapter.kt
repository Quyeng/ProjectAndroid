...
Team 10
 */
class CartApdapter(context: CartActicity, layout: Int, subjectsList: List<Cart>) : BaseAdapter() {
    var x = 0
    ...
    override fun getView(i: Int, view: View?, parent: ViewGroup?): View? {
        ...
        viewHolder.textViewSanPhamConLai!!.text = "Còn lại " + cart.sosanphamtonkho.toString() + " sản phẩm"
