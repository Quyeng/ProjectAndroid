...
import com.example.projectandroid.activity.ShirtActivity
import com.example.projectandroid.model.Product
import com.squareup.picasso.Picasso
import java.text.DecimalFormat

class ShirtAdapter(context: ShirtActivity, layout: Int, subjectsList: List<Product>) :
    BaseAdapter() {
    var x = 0
    private val context: ShirtActivity
