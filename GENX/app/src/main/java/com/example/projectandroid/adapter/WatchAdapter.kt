...
import com.example.projectandroid.activity.WatchActivity
import com.example.projectandroid.model.Product
import com.squareup.picasso.Picasso
import java.text.DecimalFormat

class WatchAdapter(context: WatchActivity, layout: Int, subjectsList: List<Product>) :
    BaseAdapter() {
    var x = 0
    private val context: WatchActivity
